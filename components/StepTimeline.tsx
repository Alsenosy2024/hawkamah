...
// generation (HWK-A2). Each row is one named stage with a status icon:
// done → teal check, running → pulsing teal dot, pending → hollow dot,
// error → red ×. It mirrors ThinkingTrace's visual language but expresses the
// "did X ✓, did Y ✓, now doing Z…" progression the long /draft run was missing.
const StepTimeline: React.FC<StepTimelineProps> = ({ steps, active, language }) => {
