...
| B6 | Converge admin config modals: تقييم الموظفين → الاثنين معاً MCQ engine + full options; استبيان البيئة modal shows all fields (+ access code/expiry) | P2 | M | 🟪 PR-OPEN | s-0629-1143-d9be | [PR #45](https://github.com/Alsenosy2024/hawkamah/pull/45) · `item/B6-converge-config-modals` | 2026-06-29 14:28 |
