...
| B5 | Onboarding-ceremony parity on ?emp=/?s= (device-checks + rules/prohibitions + consent gate, like الاثنين معاً) + unify their admin config modals (camera toggle) | P2 | M | 🟦 CLAIMED | s-0629-1143-d9be | `item/B5-onboarding-parity` | 2026-06-29 11:49 |
